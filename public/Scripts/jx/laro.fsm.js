(function (d, k) {
    ...
    function a(e, i, l) {
        var f = -1,
        m = h.call(arguments, 0);
        e = j[b.$name] || {};
        i = [];
        for (l = true; m[++f];)
            if (g(m[f]) === "boolean")
                l = m[f];
            else g(m[f]) === "object" && i.push(m[f]);
...
Laro.register(".base", function () {
    function d(e) {
        return a.call(typeof e === h ? e : function () { }, e, 1)
    }
    function k(e, i, l) {
        return function () {
            var f = this.supr;
    ...
    function g(e, i, l) {
        ...
        function f() {
            ...
            else { i || q && m.apply(this, arguments); s.apply(this, arguments) }
        }
        l[n] = this[n];
        var m = this,
            p = new l,
        ...
        f[n].implement = f.statics = function (o, u) { o = typeof o == "string" ? function () { var r = {}; r[o] = u; return r }() : o; g(this, o, m); return this }; return f
    }
    var b = this,
        c = b.Class,
        h = "function",
        j = /xyz/.test(function () { }) ? /\bsupr\b/ : /.*/,
        n = "prototype";
    d.noConflict = function () {
        b.Class = c; return this
    };
    b.Class = d; Laro.Class = d
});
    ...
    var k = d.SimpleState || d.game.SimpleState, g = (d.Class || d.base.Class)(function (a, b, c) {
        if (a != undefined) {
            ...
            for (c = 0; c < b.length; c += 2) {
                var h = b[c], j = b[c + 1]; this.stateArray[h] = j instanceof k ? j : new j(a, this, h)
            }
        ...
        update: function (a) {
            for (var b = 0; b < this.numSuspended; b++) this.stateArray[this.suspendedArray[b]].suspended(a); if (this.currentState != g.kNoState) { this.stateArray[this.currentState].update(a); this.currentState != g.kNoState && this.stateArray[this.currentState].transition() }
        },
        message: function (a) { this.currentState != g.kNoState && this.stateArray[this.currentState].message(a) },
        ...
        tryChangeState: function (a, b, c, h, j) {
            ...
            {
                console.log(b);
                this.setState(b, c, j); return true
            } return false
        },
        setState: function (a, b, c) {
            if (a == g.kNextState)
                a = this.currentState + 1; if (a == g.kNoState) {
                    for (; this.numSuspended > 0; this.numSuspended--) {
                        this.stateArray[this.suspendedArray[this.numSuspended - 1]].leave(); this.stateArray[this.suspendedArray[this.numSuspended - 1]].isSuspended = false
                    }
                ...
                for (c = 0; c < this.numPreloaded; c++)
                    this.preloadedArray[c] != a && this.stateArray[this.preloadedArray[c]].cancelPreload();
                this.numPreloaded = 0;
        ...
        isSuspended: function (a) { return this.stateArray[a].isSuspended }
