...
var Royal_Preloader =
    {
        ...
        _mode: function () {
            return "undefined" !== typeof Royal_Preloader
                && "undefined" !== typeof Royal_Preloader._mode ? Royal_Preloader._mode : "number"
        } (),
        _text: function () {
            return "undefined" !== typeof Royal_Preloader
                && "undefined" !== typeof Royal_Preloader._text ? Royal_Preloader._text : "loading..."
        } (),
        _opacity: function () {
            return "undefined" !== typeof Royal_Preloader
                && "undefined" !== typeof Royal_Preloader._opacity ? Royal_Preloader._opacity : 1
        } (),
        _images: function () {
            return "undefined" !== typeof Royal_Preloader
                && "undefined" !== typeof Royal_Preloader._images ? Royal_Preloader._images : {}
        } (),
        _scripts: function () {
            return "undefined" !== typeof Royal_Preloader
                && "undefined" !== typeof Royal_Preloader._scripts ? Royal_Preloader._scripts : {}
        } (),
        _show_info: function () {
            return "undefined" !== typeof Royal_Preloader
                && "undefined" !== typeof Royal_Preloader._show_info ? Royal_Preloader._show_info : !0
        } (),
        _show_percentage: function () {
            return "undefined" !== typeof Royal_Preloader
                && "undefined" !== typeof Royal_Preloader._show_percentage ? Royal_Preloader._show_percentage :
                !0
        } (),
        _background: function () {
            return "undefined" !== typeof Royal_Preloader
                && "undefined" !== typeof Royal_Preloader._background ? Royal_Preloader._background : ["#000000"]
        } (),
        _timeout: 10,
        ...
        _init: function () {
            ...
            $.each(Royal_Preloader._images,
                function () {
                    Royal_Preloader._total++
                });
            $.each(Royal_Preloader._scripts,
                function () {
                    Royal_Preloader._total++
                });
        ...
        _build: function () {
            ...
            "text" === this._mode
                && this._text_loader.css("margin-left", -1 * (this._text_loader.width() / 2))
        },
        _load: function () {
            "number" ===
                this._mode && this._percentage.data("num", 0).text("0%");
            $.each(this._images,
                function (a, b) {
                    var c = function () { Royal_Preloader._imageOnLoad(a, b) },
                        d = new Image;
                    d.onload = c;
                    d.onerror = c;
                    d.src = b
        ...
        _animatePercentage: function (a, b) {
            Royal_Preloader._percentage_loaded = a; a < b && (a++ , setTimeout(function () {
                "number" === Royal_Preloader._mode ? Royal_Preloader._percentage.text(a + "%") :
                ...
                : (this._name.css(
                    {
                        opacity: 1,
                        top: "50%"
                    }), this._name.animate({ top: "20%", opacity: 0 }, 300), this._overlay_bg.animate({ "background-color": this._background[this._loaded % this._background.length] }, 300, "linear"))
            //} 
        ...
        _loadFinish: function () {
            this._use_css_animation
                ? (this._overlay.addClass("complete"), $(document.body).removeClass("royal_loader"))
                : setTimeout(function () {
                    "number" === Royal_Preloader._mode
                        ? Royal_Preloader._loader.add(Royal_Preloader._percentage)
                            .animate
                            (
                            {
                                top: "70%",
                        ...
                        : (Royal_Preloader._overlay.addClass("complete"), $(document.body).removeClass("royal_loader"))
                }, 500);
            setTimeout(function () {
                if (Royal_Preloader._overlay != null) {
        ...
        config: function (a) {
            ...
            "undefined" !== typeof a.images && (this._images = a.images,
                Royal_Preloader._total = 0,
                $.each(this._images, function () { Royal_Preloader._total++ }));
            "undefined" !== typeof a.scripts && (this._scripts = a.scripts,
                Royal_Preloader._total = Royal_Preloader._total,
                $.each(this._scripts, function () { Royal_Preloader._total++ }));
        }
    };
